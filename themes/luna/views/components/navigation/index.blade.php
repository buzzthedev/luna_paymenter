...
@if($hasBanner)
    <div class="w-full bg-primary font-medium text-sm text-white text-center py-2 fixed top-0 z-[50]">
...
<div class="py-4 lg:mx-unset">
    <nav class="fixed left-1/2 -translate-x-1/2 max-w-[calc(97%)] xl:max-w-[1320px] w-full px-4 border border-neutral px-6 py-1 shadow-lg rounded-2xl lg:px-8 bg-background-secondary flex md:flex-row flex-col justify-between z-20 @if($hasBanner) top-12 @else top-6 @endif">
    <div x-data="{ 
        slideOverOpen: false 
    }"
        ...
        <div class="flex flex-row items-center justify-between w-full h-16">
            ...
            <div class="md:flex hidden flex-row ml-7 flex-1 justify-center gap-2">
                    ...
                    <x-dropdown noChevron>
                        <x-slot:trigger>
                            <div class="flex flex-col">
                                <span class="flex flex-row items-center px-4 py-2 text-sm font-semibold whitespace-nowrap text-base hover:text-base/90 rounded-xl transition bg-transparent hover:bg-primary/10 focus:bg-primary/20 border border-transparent hover:border-primary/30 gap-2 cursor-pointer">
                                    {{ $nav['name'] }}
                        ...
                        <x-slot:content>
                            ...
                            <x-navigation.link
                                ...
                                class="block px-4 py-2 rounded-lg hover:bg-primary/10 transition text-base">
                                {{ $child['name'] }}
                            </x-navigation.link>
                            @endforeach
                        </x-slot:content>
                ...
                <x-navigation.link
                    ...
                    class="flex items-center px-4 py-2 rounded-xl font-semibold text-base transition bg-transparent hover:bg-primary/10 focus:bg-primary/20 border border-transparent hover:border-primary/30 gap-2 cursor-pointer">
                    {{ $nav['name'] }}
                </x-navigation.link>
                @endif
                {{-- @if($nav['separator'])
