<div>
    ...
    <div class="w-full mb-4">
        <div class="bg-yellow-600/20 text-yellow-300 border border-yellow-500 p-4 rounded-xl">
            <p class="font-medium">
    ...
    @endif
    <div class="bg-background-secondary border border-neutral p-6 rounded-2xl mt-2">
    ...
    @if (count($views) > 0)
    <div class="bg-primary-800 rounded-2xl mt-2">
        @if (count($views) > 1)
