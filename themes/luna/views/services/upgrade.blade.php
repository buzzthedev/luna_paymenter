<div>
    ...
    <div class="grid grid-cols-3 gap-6 mt-2">
        <div class="grid md:grid-cols-2 gap-6 col-span-2">
            ...
            <div>
                ...
                <label for="product-{{ $service->product->id }}"
                    class="flex flex-col cursor-pointer bg-background-secondary hover:bg-background-secondary/80 border border-neutral peer-checked:border-secondary p-4 rounded-2xl">
                    <div
        ...
        <div class="flex flex-col gap-2 w-full col-span-1 bg-background-secondary p-3 rounded-2xl h-fit">
