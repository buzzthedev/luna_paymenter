<form
    class="bg-[#1F1F1F] border border-neutral-700 rounded-2xl shadow-lg mx-auto flex flex-col gap-2 mt-4 px-6 sm:px-14 pb-10 xl:max-w-[40%] w-full"
    ...
    <div class="flex flex-col items-center mt-4">
        ...
        <div class="flex flex-row flex-wrap justify-center mt-2 gap-4">
            ...
            <a href="{{ route('oauth.redirect', $provider) }}"
                class="flex items-center justify-center px-4 h-10 border border-neutral rounded-2xl text-primary-100">
    ...
    <div class="text-base text-center rounded-2xl py-2 mt-6 text-sm">
