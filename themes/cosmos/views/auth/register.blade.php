<form
    class="bg-[#1F1F1F] border border-neutral-700 rounded-2xl shadow-lg mx-auto flex flex-col gap-2 mt-4 px-6 sm:px-14 pb-10 xl:max-w-[60%] w-full"
    ...
    <div class="text-white text-center rounded-2xl py-2 mt-6 text-sm">
