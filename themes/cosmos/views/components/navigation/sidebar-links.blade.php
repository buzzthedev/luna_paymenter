<div class="lg:px-4 lg:py-6 flex flex-col gap-2 bg-background-secondary shadow-lg rounded-2xl border border-neutral">
    <div class="flex flex-col gap-2 md:hidden">
        ...
        <div x-data="{ activeAccordion: {{ $nav['active'] ? 'true' : 'false' }} }"
            ...
            <div class="cursor-pointer">
                <button @click="activeAccordion = !activeAccordion"
                    class="flex items-center justify-between w-full p-3 text-sm font-semibold whitespace-nowrap rounded-2xl hover:bg-primary/5">
        ...
        @else
        <div class="flex items-center rounded-2xl {{ $nav['active'] ? 'bg-primary/5' : 'hover:bg-primary/5' }}">
